...
**Get income group
import delim using "C:\Users\Administrator\Dropbox\HPC_data_hub\Phase 1 data release\Prepandemic\raw data\US_county_income.csv",rowr(2:)stringc(1 2 3 4) clear
d
sum
...
keep stfips stname ctyfips ctyname fips agi_stub mars1 mars2 mars4
ren mars1 renums
ren mars2 renumm
ren mars4 renumh
...
keep stfips stname ctyfips ctyname fips agi_stub renumg
