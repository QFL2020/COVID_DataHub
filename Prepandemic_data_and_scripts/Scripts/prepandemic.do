...
* If anyone want keep all variables, just remove the start before codes
*save prepandemic_large,replace 
*export delim using prepandemic_large.csv,  replace

* we just keep variable of nearest year
