...
import delim using "C:\Users\Administrator\Dropbox\HPC_data_hub\Phase 1 data release\Prepandemic\raw data\mig_cty.csv",stringc(2 3) numericc(10 12)clear
d
sum
*fips code and name
...
merge 1:m fips using US_county_pop.dta,force
