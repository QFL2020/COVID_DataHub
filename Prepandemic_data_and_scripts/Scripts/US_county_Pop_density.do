...
merge 1:1 fips using "C:\Users\Administrator\Dropbox\HPC_data_hub\Phase 2 data release\Prepandemic\intermediate steps\US_county_Pop.dta"
keep stname stfips ctyname ctyfips fips landarea tot*

forval i=10/18{
gen popdensity_20`i'=tot_20`i'/landarea
la var popdensity_20`i' "Population density, # people per km2 in 20`i'"
}
drop tot* landarea
